  ...
  return (
    <div className="h-screen w-screen bg-gray-900 text-gray-100 flex flex-col p-4 gap-4">
      ...
      <footer className="flex-shrink-0 text-center text-gray-500 text-xs p-2">
        Programador Full Stack: JLike Look Solutions // Comunidade Discord: <a href="https://discord.com/invite/Q87eT73pPX" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">https://discord.com/invite/Q87eT73pPX</a> // Whatsapp +551136808030 // likelook@live.com, <a href="https://likelook.wixsite.com/solutions" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">https://likelook.wixsite.com/solutions</a>
      </footer>
    </div>
  );
}
