...
export const Chat: React.FC<ChatProps> = ({ messages, onSendMessage, isLoading, activeRoadmap, onProceedWithRoadmap, isRoadmapRunning }) => {
  ...
  const shouldShowProceedButton = activeRoadmap && !isRoadmapRunning && activeRoadmap.currentStep < activeRoadmap.tasks.length;
  const isInputDisabled = isLoading || activeRoadmap !== null;
        ...
        <div className="p-2 border-t border-gray-300 dark:border-gray-700">
            <div className="relative">
                <textarea
                    ...
                    placeholder={isInputDisabled ? "Julio is working on the plan..." : "Ask to modify the code..."}
