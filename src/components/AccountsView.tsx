...
export const AccountsView: React.FC<AccountsViewProps> = ({ githubUser, setGithubUser }) => {
        ...
        <div className="p-4 space-y-6 text-sm">
            <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
                    Você pode agora importar repositórios públicos usando o importador na barra de ferramentas superior.
                </p>
                <button 
